      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-4 leading-relaxed">
              Girma Wondimu Export Trade - Your trusted partner for premium gemstones since 2009.
            </p>
            <div className="flex space-x-4">
              <a target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="group">
              ...
              <a  target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="group">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col space-y-2">
                <div className="flex items-center group hover:translate-x-1 transition-transform duration-300">
                  ...
                  <a href="tel:+251935740257" className="text-gray-400 hover:text-cyan-400 transition-colors">+251935740257</a>
                </div>
                <div className="flex items-center group hover:translate-x-1 transition-transform duration-300">
                  <Phone className="w-5 h-5 text-cyan-400 mr-3 flex-shrink-0 group-hover:text-blue-400 transition-colors" />
                  <a href="tel:+251912407676" className="text-gray-400 hover:text-cyan-400 transition-colors">+251912407676</a>
                </div>
                <div className="flex items-center group hover:translate-x-1 transition-transform duration-300">
                  <Phone className="w-5 h-5 text-cyan-400 mr-3 flex-shrink-0 group-hover:text-blue-400 transition-colors" />
                  <a href="tel:+251920919720" className="text-gray-400 hover:text-cyan-400 transition-colors">+251920919720</a>
                </div>
              </div>
              <div className="flex items-center group hover:translate-x-1 transition-transform duration-300">
        ...
        <div className="border-t border-cyan-900/50 pt-8 text-center">
          <p className="text-gray-400 flex items-center justify-center gap-2 flex-wrap">
            © 2025 Girma Wondimu Export Trade. All rights reserved. | Developed by
