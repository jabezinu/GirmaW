  ...
  const content = {
    ...
    am: {
      ...
      story: {
        title: 'ታሪካችን',
        paragraphs: [
          'በ2010 የተመሰረተው ፓዚዮን በውድ እንቁ ኢንዱስትሪ ውስጥ ግንባር ቀደም በመሆን ሁለቱንም የሀገር ውስጥና የዓለም አቀፍ ገበያዎችን በማይነፃፀር ብቃትና ታማኝነት ያገለግላል።',
          'ጉዞአችን የተጀመረው በቀላል ተልዕኮ ነው፡ በውድ እንቁ ወዳጆች፣ ባለሙያዎች እና በዓለም አቀፍ ገበያ መካከል ያለውን ክፍተት ለመሙላት። ዛሬ በውድ እንቁ ማህበረሰብ ውስጥ እንደ የታመነ አጋር ተገንዝበናል።',
          'በዓመታት ልምድ እና በተመሰከረሉ የጂዮሎጂስቶች ቡድን፣ የውድ እንቁ ንግድን በሁሉም ገፅታዎች የሚያገለግሉ አጠቃላይ አገልግሎቶችን እንሰጣለን።'
        ]
      },
      expertise: {
        title: 'እውቀታችን',
        items: [
          'የተረጋገጠ የውድ እንቁ ምርመራ እና ማረጋገጫ',
          'ዓለም አቀፍ የመግዛት እና የመሸጥ አውታረመረብ',
          'ሙያዊ ስልጠና እና የምስክር ወረቀት ፕሮግራሞች',
          'ዘመናዊ መሳሪያዎች እና መሳሪያዎች',
          'የገበያ ትንተና እና አዝማሚያ ትንበያ'
        ]
      },
      values: {
        title: 'ለምን እኛን ይመርጣሉ?',
        items: [
          {
            icon: '🏆',
            title: 'ብልጽግና',
            description: 'በምናደርገው ሁሉ ከፍተኛ ደረጃዎችን ለማሟላት ቆርጠን ቆይተናል'
          },
          {
            icon: '🤝',
            title: 'መተማመን',
